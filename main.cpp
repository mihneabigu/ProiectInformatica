...
void setariCont(char username[100][30], char password[100][30], char suma[100][30], int &linie)
{
    cout<<"Choose your option:"<<endl<<endl;
        ...
        if (choice1=='2')
        {
            ...
            afisareCasino();
            cout<<"Validating information."; Sleep(1000); cout<<"."; Sleep(1000); cout<<"."; Sleep(1000);
...
void MainMenu()
{
    ...
    while(!exitGame)
    {
        ...
        else
        {
            ...
            unsigned long deposit=atoi(suma[gasitBun]);
            afisareCasino();
                ...
                if (totalDealer==21&&totalPlayer<21)
                {
                    ...
                    if (totalPlayer==21&&totalDealer<21)
                    {
                        ...
                        if (totalPlayer==21&&totalDealer==21)
                        {
                            ...
                            cout<<"Do you want to play again? Yes(y) or No(n): "; char s;
                            cin>>s;
                            if (s=='n')
                            {
                                playAgain=0;
        ...
        if (s=='S')
            {
                ...
                v1PlayerC[1]=vPlayerCarti[1]; v1PlayerS[1]=vPlayerSimbol[1];
                v2PlayerC[1]=vPlayerCarti[2]; v2PlayerS[1]=vPlayerSimbol[2];
        ...
        if (choice=='5')
        {
            cout<<endl<<"Exiting game in 3... "; Sleep(1000); cout<<"2... "; Sleep(1000); cout<<"1... "; Sleep(1000);
            exitGame=1;
            fout.close();
        }
